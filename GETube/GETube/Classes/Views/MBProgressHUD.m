...
+ (MB_INSTANCETYPE)showHUDAddedTo:(UIView *)view animated:(BOOL)animated {
    ...
    //UIView *backView=[[UIView alloc]initWithFrame:CGRectMake(0.0, 0.0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height)];
    //backView.backgroundColor =[[UIColor blackColor] colorWithAlphaComponent:0.7];
    //hud.backgroundColor=[UIColor colorWithWhite:0.0 alpha:0.50];
    //[hud addSubview:backView];
    //hud.alpha = 0.3;
	[view addSubview:hud];
	[hud show:animated];
